...
impl Sun2000 {
    ...
    pub fn param_table() -> Vec<Parameter> {
        vec![
            ...
            Parameter::new("storage_status", ParamKind::NumberI16(None), None, Some("storage_status_enum"), 1, 37000, 1, false, true),
            Parameter::new("storage_charge_discharge_power", ParamKind::NumberI32(None), None, Some("W"), 1, 37001, 2, false, true),
